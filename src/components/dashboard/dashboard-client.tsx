...
import { createFolder } from "@/lib/supabase/folders";
...
export function DashboardClient({
  ...
  const monthlyStats = initialData.monthlyStats ?? EMPTY_MONTHLY_STATS;
  const recentItems = initialData.recentItems;
  ...
  const handleCreateItem = async (data: CreateItemData | Omit<CreateItemData, "folder_id">) => {
